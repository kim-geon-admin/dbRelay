...
it("disables dashboard controls while recovery owns the keyboard", () => {
  ...
  const connections = [{ id: "source", displayName: "Source", kind: "oracle" as const, host: "a", port: 1, serviceName: "a", username: "a", credentialStorage: "keyring" as const, enabled: true }, { id: "target", displayName: "Target", kind: "oracle" as const, host: "b", port: 1, serviceName: "b", username: "b", credentialStorage: "keyring" as const, enabled: true }];
